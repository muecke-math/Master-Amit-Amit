...
#SBATCH --job-name=tf2_navier                     # Job name
#SBATCH --output=/home/users/aamit/Project/pinns-tf2/examples/navier_stokes/outputs/navier_stokes_extra_layer20.log        # Output log file
...
python "/home/users/aamit/Project/pinns-tf2/examples/navier_stokes/train.py"
# python -c "import tensorflow as tf; print('GPUs:', tf.config.list_physical_devices('GPU'))"
