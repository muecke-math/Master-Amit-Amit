...
def main():
    ...
    save_dir = "/home/users/aamit/Project/pinns-tf2/examples/burgers_discrete_forward/EDA"
    # Path to save the basic summary statistics
    summary_file_path = os.path.join(save_dir, "data_burgers_discrete_forward.txt")
