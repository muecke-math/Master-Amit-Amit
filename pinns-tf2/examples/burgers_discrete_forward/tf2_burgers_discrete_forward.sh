...
#SBATCH --job-name=tf2_burgers_discrete_forward                     # Job name
#SBATCH --output=/home/users/aamit/Project/pinns-tf2/examples/burgers_discrete_forward/outputs/burgers_discrete_forward_optimizer_Nadam.log        # Output log file
#SBATCH --nodelist=dds3                        # Specify the node you want to use
...
python "/home/users/aamit/Project/pinns-tf2/examples/burgers_discrete_forward/train.py"
# python -c "import tensorflow as tf; print('GPUs:', tf.config.list_physical_devices('GPU'))"
