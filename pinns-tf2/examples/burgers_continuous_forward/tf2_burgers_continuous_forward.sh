...
#SBATCH --job-name=tf2_burgers_continuous_forward                     # Job name
#SBATCH --output=/home/users/aamit/Project/pinns-tf2/examples/burgers_continuous_forward/outputs/burgers_continuous_forward_optimizer_Nadam.log
#SBATCH --nodelist=dds2                        # Specify the node you want to use
...
python "/home/users/aamit/Project/pinns-tf2/examples/burgers_continuous_forward/train.py"
# python -c "import tensorflow as tf; print('GPUs:', tf.config.list_physical_devices('GPU'))"
