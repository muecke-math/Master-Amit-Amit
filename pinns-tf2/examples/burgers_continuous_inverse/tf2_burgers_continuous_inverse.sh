...
#SBATCH --job-name=tf2_burgers_continuous_inverse                     # Job name
#SBATCH --output=/home/users/aamit/Project/pinns-tf2/examples/burgers_continuous_inverse/outputs/burgers_continuous_inverse_optimizer_Nadam.log        # Output log file
#SBATCH --nodelist=dds4                        # Specify the node you want to use
...
conda activate env_pinns_tf2

# Print start time
echo "Job started at: $(date)"

export CUDA_HOME=/home/users/aamit/.conda/envs/env_pinns_tf2
...
python "/home/users/aamit/Project/pinns-tf2/examples/burgers_continuous_inverse/train.py"
# python -c "import tensorflow as tf; print('GPUs:', tf.config.list_physical_devices('GPU'))"
