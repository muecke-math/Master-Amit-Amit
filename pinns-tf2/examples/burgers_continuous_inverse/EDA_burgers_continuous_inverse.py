...
def main():
    ...
    save_dir = "/home/users/aamit/Project/pinns-tf2/examples/burgers_continuous_inverse/EDA"
    # Path to save the basic summary statistics
    summary_file_path = os.path.join(save_dir, "data_burgers_continuous_inverse.txt")
