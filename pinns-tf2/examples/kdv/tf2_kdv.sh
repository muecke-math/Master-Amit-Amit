...
#SBATCH --job-name=tf2_kdv                     # Job name
#SBATCH --output=/home/users/aamit/Project/pinns-tf2/examples/kdv/outputs/kdv_extra_layer50.log        # Output log file
...
python "/home/users/aamit/Project/pinns-tf2/examples/kdv/train.py"
# python -c "import tensorflow as tf; print('GPUs:', tf.config.list_physical_devices('GPU'))"
