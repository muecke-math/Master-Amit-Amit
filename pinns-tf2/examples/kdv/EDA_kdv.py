...
def read_data_fn(root_path):
    ...
    Expects a file named 'KdV.mat' in the given directory.
    """
    data = pinnstf2.utils.load_data(root_path, "KdV.mat")
    # Extract the real part of the "uu" variable
...
def main():
    ...
    save_dir = "/home/users/aamit/Project/pinns-tf2/examples/kdv/EDA"
    # Path to save the basic summary statistics
    summary_file_path = os.path.join(save_dir, "data_kdv.txt")
