...
#SBATCH --job-name=tf2_ac                      # Job name
#SBATCH --output=/home/users/aamit/Project/pinns-tf2/examples/ac/outputs/ac_best_N500_sigmoid.log        # Output log file
...
python "/home/users/aamit/Project/pinns-tf2/examples/ac/train.py"
# python -c "import tensorflow as tf; print('GPUs:', tf.config.list_physical_devices('GPU'))"
