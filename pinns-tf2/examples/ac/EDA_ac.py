...
def read_data_fn(root_path):
    ...
    Expects a file named 'AC.mat' in the given directory.
    """
...
def main():
    ...
    save_dir = "/home/users/aamit/Project/pinns-tf2/examples/ac/EDA"
    # Path to save the basic summary statistics
    summary_file_path = os.path.join(save_dir, "data_ac.txt")
