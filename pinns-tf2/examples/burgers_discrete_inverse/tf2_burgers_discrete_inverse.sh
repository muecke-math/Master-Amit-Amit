...
#SBATCH --job-name=tf2_burgers_discrete_inverse                     # Job name
#SBATCH --output=/home/users/aamit/Project/pinns-tf2/examples/burgers_discrete_inverse/outputs/burgers_discrete_inverse_optmizer_Nadam.log        # Output log file
#SBATCH --nodelist=dds5                        # Specify the node you want to use
...
python "/home/users/aamit/Project/pinns-tf2/examples/burgers_discrete_inverse/train.py"
# python -c "import tensorflow as tf; print('GPUs:', tf.config.list_physical_devices('GPU'))"
