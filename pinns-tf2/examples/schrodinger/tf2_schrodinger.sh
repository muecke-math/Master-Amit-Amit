...
#SBATCH --job-name=tf2_schrodinger                     # Job name
#SBATCH --output=/home/users/aamit/Project/pinns-tf2/examples/schrodinger/outputs/schrodinger_extra_layer100.log        # Output log file
...
python "/home/users/aamit/Project/pinns-tf2/examples/schrodinger/train.py"
# python -c "import tensorflow as tf; print('GPUs:', tf.config.list_physical_devices('GPU'))"
