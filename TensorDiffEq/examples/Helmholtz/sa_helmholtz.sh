...
#SBATCH --output=/home/users/aamit/Project/TensorDiffEq/examples/Helmholtz/helmholtz_extra_layer50.log        # Output log file
...
python "/home/users/aamit/Project/TensorDiffEq/examples/Helmholtz/helmholtz.py"
# python -c "import tensorflow as tf; print('GPUs:', tf.config.list_physical_devices('GPU'))"
