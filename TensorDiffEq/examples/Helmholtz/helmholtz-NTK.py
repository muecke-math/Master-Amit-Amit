...
plt.savefig(os.path.join(cwd, 'Helmholtz/Baseline_NTK/U_pred_plot.png'))
# plt.show()
...
plt.savefig(os.path.join(cwd, 'Helmholtz/Baseline_NTK/FU_pred_plot.png'))
# plt.show()
...
plot_helmholtz_figure(U_pred=U_pred,
                      ...
                      lb=[-1.0, -1.0],
                      ub=[1.0, 1.0],
                      save_dir=os.path.join(cwd, 'Helmholtz/Baseline_NTK/baseline_ntk.png'))