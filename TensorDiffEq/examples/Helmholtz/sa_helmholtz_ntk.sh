...
#SBATCH --job-name=helmholtz                       # Job name
#SBATCH --output=/home/users/aamit/Project/TensorDiffEq/examples/Helmholtz/helmholtz_baseline_ntk_new1.log        # Output log file
...
python "/home/users/aamit/Project/TensorDiffEq/examples/Helmholtz/helmholtz-NTK-new.py"
# python -c "import tensorflow as tf; print('GPUs:', tf.config.list_physical_devices('GPU'))"
